## This is news app build in <ins>Reactjs</ins> using [vite](https://vite.dev/). aslo in that app i am using external News api [Newsdata.io](https://newsdata.io/). for lestest news.
